                                ...
                                <form class="auth-login-form mt-2" action="{{route('register.store')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('asal_sekolah') is-invalid @enderror" name="asal_sekolah">
                                            ...
                                            <option value="TKJ 1" {{ old('asal_sekolah') == 'TKJ 1' ? 'selected' : '' }}>TKJ 1</option>
                                            <option value="TKJ 2" {{ old('asal_sekolah') == 'TKJ 2' ? 'selected' : '' }}>TKJ 2</option>
                                            <option value="TKJ 3" {{ old('asal_sekolah') == 'TKJ 3' ? 'selected' : '' }}>TKJ 3</option>
                                            <option value="RPL 1" {{ old('asal_sekolah') == 'RPL 1' ? 'selected' : '' }}>RPL 1</option>
                                            <option value="RPL 2" {{ old('asal_sekolah') == 'RPL 2' ? 'selected' : '' }}>RPL 2</option>
                                            <option value="RPL 3" {{ old('asal_sekolah') == 'RPL 3' ? 'selected' : '' }}>RPL 3</option>
                                            <option value="SK 1" {{ old('asal_sekolah') == 'SK 1' ? 'selected' : '' }}>SK 1</option>
                                            <option value="SK 2" {{ old('asal_sekolah') == 'SK 2' ? 'selected' : '' }}>SK 2</option>
                                            <option value="MP 1" {{ old('asal_sekolah') == 'MP 1' ? 'selected' : '' }}>MP 1</option>
                                            <option value="MP 2" {{ old('asal_sekolah') == 'MP 2' ? 'selected' : '' }}>MP 2</option>
                                            <option value="DPIB 1" {{ old('asal_sekolah') == 'DPIB 1' ? 'selected' : '' }}>DPIB 1</option>
                                            <option value="DPIB 2" {{ old('asal_sekolah') == 'DPIB 2' ? 'selected' : '' }}>DPIB 2</option>
                                            <option value="AK 1" {{ old('asal_sekolah') == 'AK 1' ? 'selected' : '' }}>AK 1</option>
                                            <option value="AK 2" {{ old('asal_sekolah') == 'AK 2' ? 'selected' : '' }}>AK 2</option>
                                            <option value="OTKP 1" {{ old('asal_sekolah') == 'OTKP 1' ? 'selected' : '' }}>OTKP 1</option>
                                            <option value="OTKP 2" {{ old('asal_sekolah') == 'OTKP 2' ? 'selected' : '' }}>OTKP 2</option>
